...
LINK=os.environ.get('LINK', "https://github.com/VaibhavG10/Simple-Python-App")
TEXT1=os.environ.get('TEXT1', "Welcome To ")
TEXT2=os.environ.get('TEXT2', " This is Test App")
LOGO=os.environ.get('LOGO', "https://github.com/VaibhavG10/Simple-Python-App/raw/master/images/CCOE.png")
COMPANY=os.environ.get('COMPANY', "Cloud COE Team")
